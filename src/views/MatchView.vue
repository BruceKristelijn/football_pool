                ...
                <div class="card bg-base-200 w-3/4 shadow-xl text-center mt-5">
                    <div class="card-body my-0">
                        ...
                        <transition name="list">
                            <div class="alert alert-success mb-2 w-3/4 mx-auto p-2" v-if="showPredictionFormSuccess">
                        ...
                        <div class="gap-2 justify-center flex flex-row items-center mx-10">
                            ...
                            <label class="form-control flex flex-col w-full max-w-xs ">
                                ...
                                <input type="number" placeholder="" class="input input-bordered w-full my-1"
                                    v-model="prediction.halftime.home" @change="validateMatchPrediction" :disabled="match_state != 0" />
                            </label>
                            <span class="w-1/2">-</span>
                            <label class="form-control flex flex-col w-full max-w-xs">Away
                                <input type="number" placeholder="" class="input input-bordered w-full my-1"
                                    v-model="prediction.halftime.away" @change="validateMatchPrediction" :disabled="match_state != 0" />
                            </label>
                        </div>
                        ...
                        <div class="gap-2 justify-center flex flex-row items-center mx-10">
                            ...
                            <label class="form-control flex flex-col w-full max-w-xs">
                                Home
                                <input type="number" placeholder="" class="input input-bordered w-full my-1"
                                    v-model="prediction.final.home" @change="validateMatchPrediction" :disabled="match_state != 0" />
                            </label>
                            <span class="w-1/2">-</span>
                            <label class="form-control flex flex-col w-full max-w-xs">
                                Away
                                <input type="number" placeholder="" class="input input-bordered w-full my-1"
                                    v-model="prediction.final.away" @change="validateMatchPrediction" :disabled="match_state != 0" />
                            </label>
                        </div>
